...
const DirectorOurSector = () => {
  ...
  const columns = [
    ...
    { key: "sector_name", label: "Sector Name", sortable: true, dataKey: "sector" },
    { key: "supervisor_incharge", label: "Supervisor Incharge", sortable: true, dataKey: "sector_incharge" },
    { key: "supervisor_mobile", label: "Supervisor Mobile", sortable: false, dataKey: "incharge_mob" },
  ...
  const handleCopy = async () => {
    ...
    const text =
      "Sector | Supervisor Incharge Report\n" +
  ...
  const handleExcel = () => {
    ...
    link.download = `Supervisor_Sectors_Report_${new Date()
      .toISOString()
      .slice(0, 10)}.csv`;
    link.click();
  };
  ...
  const handlePDF = () => {
    ...
    printWindow.document.write(`
      <html>
        ...
        <body>
          <h2>Sector | Supervisor Incharge Report</h2>
          <h4>Total Sectors: ${filteredData.length} | Date: ${new Date().toLocaleDateString()}</h4>
        ...
        <Container fluid className="dashboard-box mt-3">
          <div className="main-heading mb-4 d-flex align-items-center">
            ...
            <div>
              ...
              >
                Sector | Supervisor Incharge
              </h3>
              <p className="text-muted mb-0" style={{ fontSize: "13px" }}>
                Total Sectors: {data.length}
              </p>
            </div>
          </div>
              ...
              <Row className="mb-3 align-items-center">
                ...
                >
                  ...
                  <FormControl
                    ...
                    placeholder="Project, sector or name..."
                  />
                </Col>
              </Row>
